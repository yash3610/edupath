...
const liveConfig = {
  ...
  "my-courses": { endpoint: "/api/instructor/my-courses", columns: ["Course", "Category", "Price", "Status"], fields: ["title", "category", "price", "status"], edit: (item) => `/api/instructor/courses/${item._id}`, form: [["title", "Course title"], ["category", "Category"], ["level", "Level", "select", ["beginner", "intermediate", "advanced"]], ["price", "Price", "number"], ["description", "Description"]], remove: (item) => `/api/instructor/courses/${item._id}` },
  "create-course": { endpoint: "/api/instructor/my-courses", columns: ["Course", "Category", "Price", "Status"], fields: ["title", "category", "price", "status"], create: "/api/instructor/courses", edit: (item) => `/api/instructor/courses/${item._id}`, form: [["title", "Course title"], ["slug", "Unique slug"], ["category", "Category"], ["level", "Level", "select", ["beginner", "intermediate", "advanced"]], ["price", "Price", "number"], ["description", "Description"]], remove: (item) => `/api/instructor/courses/${item._id}` },
