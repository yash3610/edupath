...
export default function RoleDashboardHome() {
  ...
  return (
    <div className="space-y-6">
      <section className="relative overflow-hidden rounded-[28px] border border-[#f1e7db] bg-[#fff8ef] p-6 shadow-[0_24px_60px_rgba(31,28,53,.08)] dark:border-white/10 dark:bg-[#1f1c35] sm:p-8 lg:p-10">
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <h2 className="mt-5 text-3xl font-extrabold leading-tight tracking-[-0.04em] text-[#1f1c35] dark:text-white sm:text-4xl">
...
function ChartCard({ eyebrow, title, children }) {
  return <MotionCard className="p-5 sm:p-6"><SectionHeading eyebrow={eyebrow} title={title} /><div className="h-72"><ResponsiveContainer>{children}</ResponsiveContainer></div></MotionCard>;
}
