...
export const courseApi = {
  ...
  uploadLectureVideo: (lectureId, formData) => apiFormRequest(`/api/instructor/lectures/${lectureId}/video`, formData),
  uploadLectureResource: (lectureId, formData) => apiFormRequest(`/api/instructor/lectures/${lectureId}/resources`, formData),
